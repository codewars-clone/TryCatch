        ...
        <div className="media">
          ...
          <div className="media-right">
            <div onClick={()=> {createChat(prospect)}}>
                ...
                <h4 className="title is-4" >{name}  <i className="far fa-heart"></i> </h4>
                </div>
            </div>
          </div>
        </div>
        <div className='wrapper'>
        <button className="button is-success" onClick={()=> {this.handleModal()}}>See Code</button>
        <div className={`modal ${active}`}>
          ...
          <div className="modal-card">
            ...
            <footer className="modal-card-foot">
              <button className="button is-danger" onClick={()=> {this.removeModal()}}>Cancel</button>
            </footer>
          </div>
        </div>
